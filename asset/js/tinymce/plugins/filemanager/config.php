...
$base_url="http://localhost/codeigniter"; //url base of site if you want only relative url leave empty
$upload_dir = '/asset/img/'; // path from base_url to upload base dir
